...
let monsters = {
    ...
    slime: {
        name: 'Грязнотелый слизь',
        health: 3,
        damage: 40,
        attack_chance: 0.3,
        appearance_messages: [
            'Грязнотелый слизь приближается!',
            'Слизь синяя и грязная превращается в мягкий пузырь.',
            'Грязнотелый слизь вдруг появляется перед вами...',
        ],
        success_attack_messages: [
            'Грязнотелый слизь делает кусь за жопу.',
            'Грязнотелый слизь кидает в вас пузырь.',
            'Грязнотелый слизь пугает вас...',
        ],
        miss_attack_messages: [
            'Грязнотелый слизь промахивается.',
            'Грязнотелый слизь расплылся.',
            'Грязнотелый слизь упал на землю.',
        ],
        drop: [
            {item: items.power_potion, chance: 0.05},
        ],
        drop_chance: 0.7,
    },
}
